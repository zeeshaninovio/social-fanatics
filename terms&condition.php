...
<!-- BreadCrumbs Start Here -->
<!-- section share stories of blog start here -->
<section class="terms&condition-section">
    <div class="container">
        <div class="terms&condition">
            <h3 class="terms&condition-head">TERMS & CONDITION</h3>
            <div class="terms&condition-content">
                ...
                <p>
                    ...
                    Internet tend to repeat predefined chun.
                </p>
            </div>
        </div>
    </div>
</section>
<!-- section share stories of blog start End -->
