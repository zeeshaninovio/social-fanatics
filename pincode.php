...
<!-- Modal -->
<section class="enter-code-section forget-password-section ">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-8 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" id="6digit" name="6digit" placeholder="Enter 6 Digit Code" required="required">
                                </div>
